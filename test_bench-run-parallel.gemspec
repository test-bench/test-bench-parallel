...
Gem::Specification.new do |spec|
  spec.name = 'test_bench-run-parallel'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/test-bench/test-bench-run-parallel'
  ...
  spec.metadata['namespace'] = 'TestBench::Run::Parallel'
